...
Твоя судьба хранит в себе древние уроки, которые не были усвоены. Возможно, сейчас настал момент, чтобы отпустить тяжесть старых обид или нерешённых вопросов. Эта карта открывает дверь для прощения и внутренней гармонии. Прими вызов и освободи свою душу.",
    "card_2": "🔮 Твоя карта - *Звезда путеводная*
Ты стоишь на пороге важного выбора, и звёзды направляют твоё сердце. Эта карта говорит о том, что ты уже на верном пути, и впереди тебя ждёт светлый момент. Однако, будь готов к важному решению, которое станет переломным. Ты не один — твой ангел-хранитель рядом.",
    "card_3": "🔮 Твоя карта - *Врата изменений*
Энергия перемен на пороге твоей жизни. Возможно, ты чувствуешь, что что-то должно измениться, но не знаешь, с чего начать. Эта карта подскажет, что новые начинания могут быть не так страшны, как кажутся. Перемены принесут тебе не только испытания, но и несметные возможности для роста. Прими их с открытым сердцем."
}
